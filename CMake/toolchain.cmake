...
if(TARGET_NU_NUC472_ARMCC_TOOLCHAIN_INCLUDED)
    return()
endif()
set(TARGET_NU_NUC472_ARMCC_TOOLCHAIN_INCLUDED 1)
...
#
#add_definitions("-DTARGET_NUC472")

# append non-generic flags, and set NUC472-specific link script
...
set(CMAKE_EXE_LINKER_FLAGS_INIT    "${CMAKE_EXE_LINKER_FLAGS_INIT} --scatter ${CMAKE_CURRENT_LIST_DIR}/../ld/NUC472.sct --list YOTTA_CURRENT_EXE_NAME.map --summary_stderr --info summarysizes --map --symbols --info sizes --info totals --info unused --info veneers") 